...
public class ArrayUtils {
	...
	public static Object[] defaultIfNull(Object[] array, Class defaultComponentType) {
		return (array == null) ? (Object[]) Array.newInstance(ClassUtils.getNonPrimitiveType(defaultComponentType), 0)
				: array;
	}
	...
	public static Object[] defaultIfEmpty(Object[] array, Class defaultComponentType) {
		return ((array == null) || (array.length == 0))
				? (Object[]) Array.newInstance(ClassUtils.getNonPrimitiveType(defaultComponentType), 0)
				: array;
	}
	 ...
	 *
	 * <p>
	 * 该方法内部调用<code>java.helper.Arrays.asList</code>方法所返回的列表为指定数组的映像（固定长度），因此性能和内存占用上比<code>toList</code>方法更优。
	 * </p>
	 *
	 * <p>
	 * 这个方法常被用于初始化，例如：
	 ...
	 *
	 * <p>
	 * 该方法返回的列表为指定数组的复本，而<code>java.helper.Arrays.asList</code>方法所返回的列表为指定数组的映像（固定长度）。
	 * </p>
	 *
	 * <p>
	 * 这个方法常被用于初始化，例如：
