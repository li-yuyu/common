...
public class ClassUtils {
	 ...
	 *
	 * <p>
	 * 例如 <code>ClassUtil.getSuperclasses(java.helper.ArrayList.class)</code>
	 * 返回以下列表：
	 *
	 * <ol>
	 * <li><code>java.helper.AbstractList</code></li>
	 * <li><code>java.helper.AbstractCollection</code></li>
	 ...
	 *
	 * <p>
	 * 例如<code>ClassUtil.getSuperclasses(java.helper.List.class)</code>将返回一个空列表。
	 * </p>
	 *
	 * <p>
	 * 对于一个数组，此方法返回一个列表，列出所有component类型的父类的相同维数的数组类型。 例如：
	 * <code>ClassUtil.getSuperclasses(java.helper.ArrayList[][].class)</code>
	 * 返回以下列表：
	 *
	 * <ol>
	 * <li><code>java.helper.AbstractList[][]</code></li>
	 ...
	 *
	 * <p>
	 * 例如 <code>ClassUtil.getInterfaces(java.helper.ArrayList.class)</code> 返回以下列表：
	 *
	 * <ol>
	 * <li><code>java.helper.List</code></li>
	 * <li><code>java.helper.Collection</code></li>
	 * <li><code>java.helper.RandomAccess</code></li>
	 ...
	 * <code>ClassUtil.getInterfaces(java.helper.ArrayList[][].class)</code> 返回以下列表：
	 *
	 * <ol>
	 * <li><code>java.helper.List[][]</code></li>
	 * <li><code>java.helper.Collection[][]</code></li>
	 ...
	 * <li>如果目标类型 <code>clazz</code> 为原子类型，那么根据
	...
	public static boolean isAssignable(Class clazz, Class fromClass) {
		...
		if (clazz.isPrimitive()) {
			...
			if (Integer.TYPE.equals(clazz)) {
				return Integer.class.equals(fromClass) || Byte.TYPE.equals(fromClass) || Byte.class.equals(fromClass)
			...
			if (Float.TYPE.equals(clazz)) {
				return Float.class.equals(fromClass) || Long.TYPE.equals(fromClass) || Long.class.equals(fromClass)
						|| Integer.TYPE.equals(fromClass) || Integer.class.equals(fromClass)
						|| Byte.TYPE.equals(fromClass) || Byte.class.equals(fromClass) || Short.TYPE.equals(fromClass)
						|| Short.class.equals(fromClass) || Character.TYPE.equals(fromClass)
						|| Character.class.equals((fromClass));
			}
